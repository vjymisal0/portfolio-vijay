  ...
  return (
    <article className="animate-in fade-in slide-in-from-bottom-2 duration-500">
      <header>
        ...
        <h1 className="mt-5 font-display text-[2.5rem] font-normal leading-[1.04] tracking-tight text-foreground sm:text-[3.25rem]">
          {post.title}
        </h1>
      ...
      <div
        className="
          ...
          prose-a:font-medium prose-a:text-foreground prose-a:underline prose-a:decoration-muted-foreground/40 prose-a:underline-offset-[3px] hover:prose-a:decoration-foreground
          prose-code:font-sans prose-code:text-[0.9em] prose-code:text-foreground prose-code:before:content-[''] prose-code:after:content-['']
          prose-blockquote:border-l-2 prose-blockquote:border-foreground/30 prose-blockquote:pl-5 prose-blockquote:font-reading prose-blockquote:not-italic prose-blockquote:text-muted-foreground
        "
      >
