  ...
  return (
    <div className={`pointer-events-none absolute inset-0 overflow-hidden ${className}`}>
      <motion.div
        ...
        className="absolute inset-0 scale-[2.2] transform-gpu opacity-[0.14] [background-image:repeating-linear-gradient(100deg,var(--aurora-1)_10%,var(--aurora-2)_15%,var(--aurora-3)_20%,var(--aurora-4)_25%,var(--aurora-1)_30%)] [background-size:200%_200%]"
        style={
          {
            '--aurora-1': '#3b82f6',
            '--aurora-2': '#6366f1',
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_10%,hsl(var(--background))_55%)]" />
    </div>
  )
}
